 ...
 *  - Jeder Translate('...')-Text (module.php, libs und form.json-Skripte, z. B. onClick)
...
$moduleDirs = ['SymconWLEDDiscovery', 'SymconWLEDMaster', 'SymconWLEDSegment', 'SymconWLEDSplitter'];
$root       = dirname(__DIR__);
$fail       = false;

$libsCode = '';
foreach (glob($root . '/libs/*.php') ?: [] as $libFile) {
    $libsCode .= file_get_contents($libFile) . "\n";
}
...
foreach ($moduleDirs as $moduleDir) {
    ...
    // 2) Translate-Aufrufe aus module.php, den libs und den Skripten in form.json (z. B. onClick)
 ...
 * Case-insensitiv, da im Code auch kleingeschriebenes ->translate(...) vorkommt.
 *
